 ...
 <div class="comment-form-wrap pt-5">
 	<div class="container">
 		<div class="col-md-8 mb-5" style="margin: 0 auto;">
                ...
                <form method="post" action="#" class="p-4 bg-light" enctype="multipart/form-data" onsubmit="return check(this)">
                  <input type="hidden" value="${dto.r_no}" name="r_no">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="r_subject" id="r_subject" value="${dto.r_subject}">
                  </div>
                  <div class="form-group">
			      ...
			      <img src="storage/${dto.poster }" width="80">
			      <input type='file' name='posterMF' size='50'>  
		    	  </div>
                  <div class="form-group">
                    <label for="content">content *</label>
                    <textarea name="r_content" id="r_content" cols="30" rows="10" class="form-control">${dto.r_content}</textarea>
                  </div>
                  ...
                  <div class="form-group">
                    <input type="submit" value="Register" class="btn btn-primary" onclick="update();">
